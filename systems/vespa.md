...
type: system
sources: [vespa-docs, radford-2021-clip, kusupati-2022-matryoshka]
related: [milvus.md, qdrant.md, pinecone.md, weaviate.md, faiss.md, spann.md, diskann.md, vbase.md, analyticdb-v.md, pase.md, freshdiskann.md, ../concepts/hnsw.md, ../concepts/acorn.md, ../concepts/filtered-vamana.md, ../concepts/product-quantization.md, ../concepts/rabitq.md, ../concepts/relaxed-monotonicity.md, ../concepts/clip.md, ../concepts/matryoshka-embedding.md, ../topics/attribute-filtering.md, ../topics/disk-vs-memory-ann.md, ../topics/index-selection.md, ../topics/in-place-vs-out-of-place-updates.md, ../topics/topk-vs-iterator-model.md, ../topics/multi-vector-queries.md, ../topics/multimodal-embedding-retrieval.md, ../topics/adaptive-retrieval-shortlist-rerank.md]
created: 2026-05-11
updated: 2026-05-11 (MRL as matryoshka cell type origin)
---
