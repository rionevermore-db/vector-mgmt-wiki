...
type: concept
sources: [fu-2017-nsg, guo-2019-scann, subramanya-2019-diskann, wang-2024-starling, singh-2021-freshdiskann, ootomo-2023-cagra]
related: [hnsw.md, nsw.md, proximity-graph.md, product-quantization.md, scann.md, vamana.md, block-shuffling.md, freshvamana.md, cagra-graph.md, ../systems/diskann.md, ../systems/milvus.md, ../systems/starling.md, ../systems/freshdiskann.md, ../systems/cagra.md, ../topics/mips-vs-l2-nn.md, ../topics/disk-vs-memory-ann.md, ../topics/in-place-vs-out-of-place-updates.md, ../topics/gpu-vs-cpu-ann.md, ../benchmarks/nsg-vs-graph-anns-million.md, ../benchmarks/diskann-sift1b.md, ../benchmarks/starling-vs-diskann-spann-on-segment.md, ../benchmarks/freshdiskann-streaming-sift800m.md, ../benchmarks/cagra-vs-hnsw-ggnn-ganns.md]
created: 2026-05-07
...
- **NSG 在 GPU 上的等效**：[CAGRA](./cagra-graph.md) [ootomo-2023] §V-B 实测——CAGRA graph 与 NSSG (NSG 后继) graph **质量 comparable**（同 NSSG search 实现下 recall-throughput 几乎重合），但 CAGRA build **5-30× 快**（GPU vs CPU 64-core）。NSG 的 MRNG monotonic property 与 CAGRA fixed-degree + rank-based reordering 是不同 first-principles design——CPU/GPU graph 各自最优形态。详见 [systems/cagra.md](../systems/cagra.md)。
